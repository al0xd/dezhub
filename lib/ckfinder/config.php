...
$ufolder = ($_COOKIE['dzh_uid'])?md5(intval($_COOKIE['dzh_uid'])):"public";

$baseUrl = SITE_URL."public/upload/userfiles/".$ufolder."/"; 
...
*/
if($baseUrl[0]!="/")
	$baseDir = SITE_DIR."public/upload/userfiles/{$ufolder}/";
else
	$baseDir = resolveUrl($baseUrl);
