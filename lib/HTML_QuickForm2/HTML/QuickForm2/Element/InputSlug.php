 ...
 */
class HTML_QuickForm2_Element_InputSlug extends HTML_QuickForm2_Element
{
   /**
    ...
    */
    ...
    public function __toString()
    {
		if ($this->frozen) {
			...
			<span class="add-on">'.$this->attributes['data-title'].'</span><input class="m-wrap " 
			type="text"  '.$this->getAttributes(true).'/></div>
			';
			return $str;
		}
    }
