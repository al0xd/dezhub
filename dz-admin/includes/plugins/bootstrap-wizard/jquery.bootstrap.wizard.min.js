...
f=h.find("li:first");}if(g.firstIndex()>=g.currentIndex()){b("li.previous",e).addClass("disabled");}else{b("li.previous",e).removeClass("disabled");}if(g.currentIndex()>=g.navigationLength()){b("http://boot.local/preview/metronic_admin/assets/plugins/bootstrap-wizard/li.next",e).addClass("disabled");
}else{b("http://boot.local/preview/metronic_admin/assets/plugins/bootstrap-wizard/li.next",e).removeClass("disabled");}if(c.onTabShow&&typeof c.onTabShow==="function"&&c.onTabShow(f,h,g.currentIndex())===false){return false;
