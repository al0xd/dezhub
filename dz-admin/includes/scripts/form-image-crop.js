var FormImageCrop = function () {
    ...
    var demo5 = function() {
        ...
        $('#img1').click(function(e) {
          ...
          jcrop_api.setImage('assets/plugins/jcrop/demos/demo_files/sago.jpg'/*tpa=http://boot.local/preview/metronic_admin/assets/scripts/assets/plugins/jcrop/demos/demo_files/sago.jpg*/);
        ...
        $('#img2').click(function(e) {
          ...
          jcrop_api.setImage('assets/plugins/jcrop/demos/demo_files/pool.jpg'/*tpa=http://boot.local/preview/metronic_admin/assets/scripts/assets/plugins/jcrop/demos/demo_files/pool.jpg*/);
          jcrop_api.setOptions({ bgOpacity: .6 });
          return false;
        });
        $('#img3').click(function(e) {
          ...
          jcrop_api.setImage('assets/plugins/jcrop/demos/demo_files/sago.jpg'/*tpa=http://boot.local/preview/metronic_admin/assets/scripts/assets/plugins/jcrop/demos/demo_files/sago.jpg*/,function(){
            this.setOptions({
              bgOpacity: 1,
              outerImage: 'assets/plugins/jcrop/demos/demo_files/sagomod.jpg'/*tpa=http://boot.local/preview/metronic_admin/assets/scripts/assets/plugins/jcrop/demos/demo_files/sagomod.jpg*/
            });
