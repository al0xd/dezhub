    ...
    return {
        ...
        init: function () {
            ...
            $('#inline').on('change', function (e) {
                if ($(this).is(':checked')) {
                    window.location.href = 'http://boot.local/preview/metronic_admin/assets/scripts/form_editable.html?mode=inline';
                } else {
                    window.location.href = 'http://boot.local/preview/metronic_admin/assets/scripts/form_editable.html';
                }
            });
