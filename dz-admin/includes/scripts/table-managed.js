var TableManaged = function () {
    ...
    return {
        ...
        init: function () {
            ...
            jQuery('#TableGrid .group-checkable').change(function () {
            ...
            jQuery('#TableGrid_wrapper .dataTables_filter input').addClass("m-wrap medium"); // modify table search input
            jQuery('#TableGrid_wrapper .dataTables_length select').addClass("m-wrap small"); // modify table per page dropdown
            //jQuery('#TableGrid_wrapper .dataTables_length select').select2(); // initialize select2 dropdown
