var FormComponents = function () {
    ...
    var handleSelect2 = function () {
        ...
        $('#select2_sample2,.select2_sample2').select2({
        ...
        function format(state) {
            ...
            return "<img class='flag' src='assets/img/flags/- + state.id.toLowerCase() + -.png'/*tpa=http://boot.local/preview/metronic_admin/assets/scripts/assets/img/flags/%22 + state.id.toLowerCase() + %22.png*//>&nbsp;&nbsp;" + state.text;
        }
		...
		var preload_data = new Array();
		 $.get("/dz-admin/?amod=post&atask=tags&task=autocomplete&ajax",function(data){
				preload_data =data;
			},"json");
       $(".inputTags").select2({
            tags: function (){
    ...
    var handleMultiSelect = function () {
		var data = [];
		var multi = $('.my_multi_select1');
			if(multi.length>0){
			var selected = $("input[name='"+multi.attr('data-input')+"']").val();
		...
		//	console.log(data);
			...
			multi.multiSelect({
				afterSelect: function(values){
					data.push($.parseJSON(values));
					$("input[name='"+multi.attr('data-input')+"']").val(data);
				},
				afterDeselect: function(values){
					var index =  data.indexOf($.parseJSON(values).toString());
					data.splice( index, 1);
					//data.pop($.parseJSON(values));
					$("input[name='"+multi.attr('data-input')+"']").val(data);
				}
			});
		}
    ...
    var handleInputMasks = function () {
        ...
        $(".mask_currency").inputmask('999.999.999 VND', { numericInput: true ,autoUnmask:true});  //123456  =>  € ___.__1.234,56
        ...
        input.keydown(function(){
            if (initialized === false) {
                ...
                input.pwstrength({
                    raisePower: 1.4,
                    minChar: 8,
                    verdicts: ["Yếu", "Trung bình yếu", "Trung bình", "Mạnh", "Cực mạnh"],
    ...
    var handleUsernameAvailabilityChecker1 = function () {
        ...
        $("#username1_checker").click(function(e){
            ...
            $.post('http://boot.local/preview/metronic_admin/assets/scripts/demo/username_checker.php', {username: input.val()}, function(res) {
