var Inbox = function () {
    ...
    var loadInbox = function (el, name) {
        var url = 'http://boot.local/preview/metronic_admin/assets/scripts/inbox_inbox.html';
    ...
    var loadMessage = function (el, name, resetMenu) {
        var url = 'http://boot.local/preview/metronic_admin/assets/scripts/inbox_view.html';
    ...
    var initWysihtml5 = function () {
        $('.inbox-wysihtml5').wysihtml5({
            "stylesheets": ["assets/plugins/bootstrap-wysihtml5/wysiwyg-color.css"/*tpa=http://boot.local/preview/metronic_admin/assets/scripts/assets/plugins/bootstrap-wysihtml5/wysiwyg-color.css*/]
        });
    }
    ...
    var loadCompose = function (el) {
        var url = 'http://boot.local/preview/metronic_admin/assets/scripts/inbox_compose.html';
    ...
    var loadReply = function (el) {
        var url = 'http://boot.local/preview/metronic_admin/assets/scripts/inbox_reply.html';
    ...
    var loadSearchResults = function (el) {
        var url = 'http://boot.local/preview/metronic_admin/assets/scripts/inbox_search_result.html';
