    ...
    var handleSidebarToggler = function () {
        ...
        $('.page-sidebar').on('click', '.sidebar-toggler', function (e) {            
            ...
            if ((body.hasClass("page-sidebar-hover-on") && body.hasClass('page-sidebar-fixed')) || sidebar.hasClass('page-sidebar-hovering')) {
                ...
                e.stopPropagation();
                runResponsiveHandlers();
				$.removeCookie('slidebar_close', { path: '/' });
                return;
            }
            ...
            if (body.hasClass("page-sidebar-closed")) {
				...
				$.cookie('slidebar_close', 'on', { expires: 7, path: '/' });
            }
            runResponsiveHandlers();
        });
        ...
        $('.page-sidebar').on('keypress', '.sidebar-search input', function (e) {
            if (e.which == 13) {
                ...
                window.location.href = "index.php?amod=post&atask=post&sort_by=post_id&sort_value=desc&per_page=20&post_title="+$(".sidebar-search input[name='keyword']").val();
