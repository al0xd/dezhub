var UITree = function () {
    ...
    return {
        ...
        init: function () {
            ...
            $("#tree_1").on("http://boot.local/preview/metronic_admin/assets/scripts/openbranch.tree", "[data-toggle=branch]", function (e) {
            ...
            $("#tree_1").on("http://boot.local/preview/metronic_admin/assets/scripts/closebranch.tree", "[data-toggle=branch]", function (e) {
