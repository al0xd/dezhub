...
<head>
	<meta charset="utf-8" />
	<title>Dezhub | Đăng nhập trang quản trị</title>
	<meta content="width=device-width, initial-scale=1.0" name="viewport" />
	<meta content="" name="description" />
	<meta content="" name="author" />
	<!-- BEGIN GLOBAL MANDATORY STYLES -->
	<link href="includes/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css"/>
	<link href="includes/plugins/bootstrap/css/bootstrap-responsive.min.css" rel="stylesheet" type="text/css"/>
	<link href="includes/plugins/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css"/>
	<link href="includes/css/style-metro.css" rel="stylesheet" type="text/css"/>
	...
	<link href="includes/css/pages/login-soft.css" rel="stylesheet" type="text/css"/>
...
<body class="login">
	<!-- BEGIN LOGO -->
	<div class="logo">
		<img src="includes/img/logo-big.png" alt="" /> 
	</div>
	<!-- END LOGO -->
	<!-- BEGIN LOGIN -->
	<div class="content">
		<!-- BEGIN LOGIN FORM -->
		<form class="form-vertical login-form" action="?task=login" method="post">
			<h3 class="form-title">Đăng nhập quản trị</h3>
			{if $tpl_error}<div class="alert alert-error show">
				<button class="close" data-dismiss="alert"></button>
				<span>Bạn đã đăng nhập sai quá 5 lần. Xin hãy thử lại sau 15 phút.</span>
			</div>{/if}
			{if $error}<div class="alert alert-error show">
				<button class="close" data-dismiss="alert"></button>
				<span>{$error}</span>
			</div>{/if}
            <div class="alert alert-error hide">
				<button class="close" data-dismiss="alert"></button>
				<span>Xin hãy nhập tên đăng nhập và mật khẩu</span>
			</div>
	...
	<!-- BEGIN COPYRIGHT -->
	<div class="copyright">
		2013 &copy; Dezhub Framework - Admin Dashboard.
	</div>
	<!-- END COPYRIGHT -->
	<!-- BEGIN JAVASCRIPTS(Load javascripts at bottom, this will reduce page load time) -->
	<!-- BEGIN CORE PLUGINS -->   <script src="includes/plugins/jquery-1.10.1.min.js" type="text/javascript"></script>
	...
	<script src="includes/plugins/backstretch/jquery.backstretch.min.js" type="text/javascript"></script>
	...
	<script src="includes/scripts/login-soft.js" type="text/javascript"></script>      
